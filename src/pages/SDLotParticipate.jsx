    ...
    <div className="grid gap-5 max-w-6xl mx-auto">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <button onClick={() => navigate(lot.globalDealType === 'ASSET' ? '/asset' : '/sd-lots')}
          ...
          style={{ color: 'var(--text-muted)' }}>
          <ArrowLeft /> {lot.globalDealType === 'ASSET' ? 'Asset Deals' : 'SD Lots'}
        </button>
      ...
      <div className="flex flex-col lg:flex-row gap-5 items-start">
        ...
        {/* Asset & Borrower Details (Only for ASSET globalDealType) */}
        {lot.globalDealType === 'ASSET' && (
          <div className="rounded-2xl p-5 grid gap-4 mt-4 animate-fadeIn"
            style={{ background: 'var(--surface-card)', border: '1px solid var(--border)', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-muted" style={{ color: 'var(--text-muted)' }}>Asset Value</p>
